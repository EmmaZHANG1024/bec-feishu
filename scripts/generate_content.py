...
## 听力任务
一段约 120 词的英文商务对话（以文字材料呈现，先让学习者听/读一遍再作答），附 3 个英文理解题。提示学习者：可配合剑桥官网 B2 Business Vantage 免费样题音频做真实听力练习。
...
注意：除「参考答案与讲解」这一节外，前面的题目部分绝对不要出现任何答案。任务部分（参考答案之前）控制在 800 词以内，简明精炼。"""
...
## 阅读专练
按 BEC 阅读真题题型出题（匹配题 / 多项选择 / 句子填空 / 完形填空 / 改错题轮流安排），给出 1 组题（含原文材料与题干，总篇幅控制在 400 词以内）。

## 听力专练
一段约 150 词的英文商务对话或独白（文字版，提示配合官方样题音频练习），按听力真题题型出 3 题（填空/选择/匹配轮换）。
